// src/screens/Eleves/EleveDetailScreen.tsx
    ...
    <View style={styles.container}>
      <Card style={styles.card}>
        <Card.Content style={styles.cardContent}>
          ...
          <View style={styles.infoBlock}>
            <Text style={styles.label}>Date & Heure marquée</Text>
            <Text style={styles.value}>
              {new Date(eleve.created_at).toLocaleString([], {
                day: '2-digit',
                month: '2-digit',
                year: 'numeric',
                hour: '2-digit',
      ...
      <Button
        ...
        icon="chart-bar"
        onPress={() =>
          navigation.navigate('StatsEleve', {
            eleve_id: eleve.id,
            nom: eleve.nom,
            prenom: eleve.prenom,
          })
